...
(function () {
    ...
    const SEARCH_INDEX = [
        ...
        // --- 互動課程 ---
        { title: '生物多樣性與保育', desc: '棲地模擬實驗室', icon: '🌿', url: basePath + 'modules/biodiversity-sim/index.html' },
        { title: '分子遺傳學中心法則', desc: 'DNA 複製、轉錄與轉譯', icon: '🧬', url: basePath + 'modules/central-dogma-sim/index.html' },
        { title: '思辨與閱讀平台', desc: '議題辯論模擬', icon: '💬', url: basePath + 'modules/chinese-debate-platform/index.html' },
        { title: '多媒體故事工坊', desc: 'AI 劇本建築師 / 詩詞共鳴', icon: '🎭', url: basePath + 'modules/chinese-multimedia-lab/index.html' },
        { title: '設計思考挑戰', desc: '校園永續改造實作', icon: '💡', url: basePath + 'modules/design-thinking-sim/index.html' },
        { title: '電磁波與光速', desc: '馬克士威方程組視覺化', icon: '📡', url: basePath + 'modules/electromagnetic-waves/index.html' },
        { title: '海岸守護者', desc: '氣候韌性城市規劃', icon: '🌊', url: basePath + 'modules/environmental-impact-sim/index.html' },
        { title: '時空地圖實驗室', desc: 'GIS 古今地圖疊合', icon: '🗺️', url: basePath + 'modules/gis-spatial-history/index.html' },
        { title: '國際議題與批判性閱讀', desc: '媒體識讀、觀點偵探', icon: '🌐', url: basePath + 'modules/international-issues/index.html' },
        { title: '光的干涉及繞射', desc: '惠更斯原理、雙狹縫干涉', icon: '🌈', url: basePath + 'modules/light-interference/index.html' },
        { title: '機電整合與控制', desc: '馬達控制、感測器', icon: '⚙️', url: basePath + 'modules/mechatronics-control-sim/index.html' },
        { title: '量子現象實驗室', desc: '原子光譜、光電效應', icon: '⚛️', url: basePath + 'modules/quantum-phenomena/index.html' },
        { title: '萬有引力定律', desc: '引力場視覺化', icon: '🪐', url: basePath + 'modules/universal-gravitation/index.html' },
        { title: '簡諧運動(SHM)彈簧振子', desc: '位置/速度/能量轉換', icon: '⚙️', url: basePath + 'modules/physics-shm/index.html' },
        { title: '克卜勒行星運動定律', desc: '橢圓軌道與掃掠面積', icon: '🪐', url: basePath + 'modules/physics-kepler/index.html' },
        { title: '細胞構造與功能', desc: '互動概念圖與自我評量', icon: '🔬', url: basePath + 'modules/biology/index.html' },
        { title: '細胞分裂：有絲 vs 減數', desc: '染色體動態變化對比', icon: '🔬', url: basePath + 'modules/biology-cell-division/index.html' },
        { title: '生態金字塔與能量流動', desc: '10% 能量傳遞定律', icon: '🌲', url: basePath + 'modules/biology-eco-pyramid/index.html' },
        { title: '經濟學供需模型', desc: '價格與數量均衡點', icon: '📈', url: basePath + 'modules/social-econ-model/index.html' },
        { title: '台灣歷史時間軸', desc: '關鍵歷史時刻與轉捩點', icon: '📜', url: basePath + 'modules/history-timeline/index.html' },
        { title: '色彩理論與混色圖學', desc: 'RGB / CMYK 與互補色', icon: '🎨', url: basePath + 'modules/art-color-theory/index.html' },
        // --- 數學（新增） ---
        { title: '二次函數圖形探索', desc: '參數即時調整拋物線', icon: '📐', url: basePath + 'modules/math-quadratic/index.html' },
        { title: '三角函數視覺化', desc: '單位圓 + 波形同步動畫', icon: '📏', url: basePath + 'modules/math-trigonometry/index.html' },
        { title: '統計與機率模擬', desc: '骰子模擬、常態分佈', icon: '🎲', url: basePath + 'modules/math-statistics/index.html' },
        { title: '向量與空間概念', desc: '2D 向量加法/內積/外積', icon: '📐', url: basePath + 'modules/math-vectors/index.html' },
        { title: '排列組合計算器', desc: 'P(n,r)/C(n,r) 樹狀圖', icon: '🎯', url: basePath + 'modules/math-combinatorics/index.html' },
        { title: '微積分初步', desc: '極限與導數、黎曼和定積分', icon: '📉', url: basePath + 'modules/math-calculus/index.html' },
        // --- 化學（新增） ---
        { title: '互動週期表', desc: '元素性質、電子組態查詢', icon: '⚗️', url: basePath + 'modules/chemistry-periodic-table/index.html' },
        { title: '酸鹼滴定模擬', desc: '虛擬滴定實驗與 pH 曲線', icon: '🧪', url: basePath + 'modules/chemistry-titration/index.html' },
        { title: '化學平衡與勒沙特列原理', desc: '反應速率與平衡移動動力學', icon: '⚖️', url: basePath + 'modules/chemistry-equilibrium/index.html' },
    ];
